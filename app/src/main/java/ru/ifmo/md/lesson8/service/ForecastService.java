...
public class ForecastService extends IntentService {
    ...
    public static final String ACTION_FORECASTS_FETCH = "ru.ifmo.md.lesson8.FORECASTS_FETCH";
    public static final String ACTION_GET_LOCATION_WOEID = "ru.ifmo.md.lesson8.LOCATION_FETCH";
    public static final String ACTION_UPDATE_ALL= "ru.ifmo.md.lesson8.ALL_UPDATE";
    public static final String ACTION_UPDATE_CITIES_LIST = "ru.ifmo.md.lesson8.CITIES_UPDATE";
