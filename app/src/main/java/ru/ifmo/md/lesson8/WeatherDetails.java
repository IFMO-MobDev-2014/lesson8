...
public class WeatherDetails extends Fragment{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        if (item == null || !item.isLoaded()) {
            l = inflater.inflate(R.layout.notloaded, container, false);
            TextView t = (TextView) l.findViewById(R.id.currLock);
            if (item == null) {
                t.setText("Current location");
            } else {
                t.setText(item.getName());
            }
        } else {
            l = inflater.inflate(R.layout.fragment_weather_details, container, false);
